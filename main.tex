...
\end{center}
\ss{5.3}
\ms Since we know that exponentiation is abacus computable (and, technically, the zero function is abacus computable), the composition $f(x)=0^x$ is abacus computable.  But this is equal to
